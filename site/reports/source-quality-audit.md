# Source Quality Audit — 2026-07-10

- Verified records: 516
...
- [千问 - 阿里Qwen大模型打造的AI对话助手](https://qianwen.aigc.cn/) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
- [AI工具集官网 | 1000+ AI工具集合，国内外AI工具集导航大全](https://ai-bot.cn/) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
...
- [morkie à Québec - Petites annonces classées Animaux LesPAC.com](https://www.lespac.com/quebec/morkie_b10g15398k1R1.jsa) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
- [Éleveur de Morkie au Québec : tous les élevages - Chien.com](https://www.chien.com/adresse/1-0-546-38-38010-elevage-morkie-quebec-1.php) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
- [Google Help](https://support.google.com/?hl=en) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
- [QUERY function - Google Docs Editors Help](https://support.google.com/docs/answer/3093343?hl=en) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
- [GOOGLEFINANCE - Google Docs Editors Help](https://support.google.com/docs/answer/3093281?hl=en) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
- [Google Sheets function list - Google Docs Editors Help](https://support.google.com/docs/table/25273?hl=en) — Auto-rejected by scoring/source-quality rules: low confidence, fallback/noisy, generic, duplicate, or weak direct relevance.
